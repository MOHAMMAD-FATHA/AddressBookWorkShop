...
public class AddressBookService
{
    ...
    {
        String sql = "update address_book set PhoneNumber = "+phoneNumber+" where Firstname = '"+name+"';";
        try(Connection connection = this.getConnection())
        {
            Statement statement = connection.createStatement();
    ...
    {
        String sql = "select * from address_book where Firstname = '"+name+"'; ";
    ...
    {
        PersonDetails personDetails = contactListDB.stream().filter(contacts -> contacts.getFirstName().equals(name)).findFirst().orElse(null);
